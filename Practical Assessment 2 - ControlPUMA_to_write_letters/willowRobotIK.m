function qOpts = willowRobotIK(eeTform, enforceJointLimits, sortByDistance, referenceConfig)
%willowRobotIK Function for generating closed-form inverse kinematics solutions to the DH robot given by the parameters specified below
%   $Revision: $ $Date: $
%
%   Generated on 27-Jan-2024 14:43:05


dhParams = [0 1.5707963267949 0.0749299999999999 0;0.4318 0 0.16764 0;-6.3142664498399e-10 1.570796325 -0.0381000006314266 0;0 1.570796325 0.432089 0;0 -1.570796325 -9.57397801058757e-11 0;0 0 0.0533399999999999 0];
thetaOffsets = [1.5707963267949 0 3.14159265358979 3.14159265358979 0 0];
lastThreeAxesSign = [1 -1 1];
jointLimits = [-3.14159265 3.14159265;-1.570796325 1.570796325;-1.570796325 1.570796325;-1.570796325 1.570796325;-1.570796325 1.570796325;-1.570796325 1.570796325];
...
baseToWorldTform = [0 -1 1.79489651492081e-09 -9.84752023946151e-10;1 0 0 0;0 1.79489651492081e-09 1 -0.54864;0 0 0 1];
...
eeToJt5 = [1 0 0 0;0 1.79489651492081e-09 -1 -9.57397772172186e-11;0 1 1.79489651492081e-09 -0.0533399999999999;0 0 0 1];
